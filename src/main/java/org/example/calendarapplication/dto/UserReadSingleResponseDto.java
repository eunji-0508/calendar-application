...
@Getter
public class UserReadSingleResponseDto {
    ...
    // 생성자
    public UserReadSingleResponseDto(Long id, String username, String email, LocalDateTime createdAt, LocalDateTime modifiedAt) {
        this.id = id;
